...
export default function ServicesPage({ onOpenLogin, onBack, onNavigate }) {
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans services-page-wrapper" style={{ width: '100%', paddingTop: 'calc(var(--section-pad-top))' }}>
