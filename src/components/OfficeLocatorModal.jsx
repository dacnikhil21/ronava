    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-dialog" onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '1.25rem' }}>
          ...
          <div className="card" style={{ padding: '1rem', backgroundColor: '#F8FAFC', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <span style={{ fontSize: '0.625rem', fontWeight: 800, padding: '0.125rem 0.5rem', background: '#DBEAFE', color: '#1E40AF', borderRadius: '4px', width: 'fit-content', textTransform: 'uppercase' }}>
              HEAD OFFICE — TIRUPATI
            </span>
            <h4 style={{ fontSize: '1rem', fontWeight: 800, color: '#0F172A', margin: 0 }}>RONAV Technologies Head Office</h4>
            <p style={{ fontSize: '0.78125rem', color: '#475569', margin: 0, lineHeight: 1.4 }}>
            ...
            <div style={{ paddingTop: '0.5rem', display: 'flex', flexWrap: 'wrap', gap: '1rem', fontSize: '0.75rem', fontWeight: 700, borderTop: '1px solid #E2E8F0' }}>
              <a href="tel:9966203038" style={{ display: 'flex', alignItems: 'center', gap: '0.375rem', color: '#0F52BA', textDecoration: 'none' }}>
                <Phone style={{ width: '14px', height: '14px' }} /> 9966203038
              </a>
              <a href="https://wa.me/919966203037" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '0.375rem', color: '#059669', textDecoration: 'none' }}>
                <MessageSquare style={{ width: '14px', height: '14px' }} /> 9966203037 (WhatsApp)
              </a>
            </div>
          </div>
          ...
          <div className="card" style={{ padding: '1rem', backgroundColor: '#F8FAFC', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            ...
            <h4 style={{ fontSize: '1rem', fontWeight: 800, color: '#0F172A', margin: 0 }}>RONAV Technologies Corporate Office</h4>
            <p style={{ fontSize: '0.78125rem', color: '#475569', margin: 0, lineHeight: 1.4 }}>
            ...
            <p style={{ fontSize: '0.75rem', color: '#475569', margin: 0, wordBreak: 'break-all' }}>
              Email: <a href="mailto:ronavtechnologies@gmail.com" style={{ color: '#0F52BA', fontWeight: 700, textDecoration: 'none' }}>ronavtechnologies@gmail.com</a>
            </p>
          </div>
        </div>
        ...
        <div style={{ padding: '1.25rem', borderRadius: '16px', background: 'linear-gradient(135deg, #0A192F 0%, #0F52BA 100%)', color: '#FFFFFF', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <div>
            <h4 style={{ fontSize: '0.9375rem', fontWeight: 800, color: '#FFFFFF', margin: 0 }}>Offices in Andhra Pradesh & Telangana</h4>
            <p style={{ fontSize: '0.75rem', color: '#BFDBFE', marginTop: '0.25rem' }}>Mon–Sat: 9:00 AM – 7:00 PM IST | Direct Merchant Support</p>
          </div>
          <a 
            href="https://maps.google.com/?q=Chandragiri+Tirupati" 
            target="_blank" 
